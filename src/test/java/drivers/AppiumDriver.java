...
public class AppiumDriver implements WebDriverProvider {
    ...
    public WebDriver createDriver(@Nonnull Capabilities capabilities) {
        ...
        options.setAutomationName(ANDROID_UIAUTOMATOR2)
                ...
                .setDeviceName(mobileConfig.mobileDevice())
                .setPlatformVersion(mobileConfig.mobileVersion())
                .setApp(getAppPath())
                .setAppPackage(mobileConfig.mobileAppPackage())
                .setAppActivity(mobileConfig.mobileAppActivity());
